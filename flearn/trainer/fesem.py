...
class FeSEM(GroupBase):
    ...
    def group_cold_start(self):
        ...
        for idx, g in enumerate(self.groups):
            ...
            tf.random.set_random_seed(new_seed)
            new_model = self.model_loader(
    ...
    def clients_cold_start(self, clients, groups):
        ...
        for client in clients:
            diffs = [_calculate_l2_distance(
                client.local_soln, g.latest_params) for g in groups]
